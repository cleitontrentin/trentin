...
public class FuncionarioController {
	 ...
	 * 
	 * @GetMapping("/buscar/cargo") public String getPorCargo(@RequestParam("id")
	 * Long id, ModelMap model) { model.addAttribute("funcionarios",
	 * funcionarioService.buscarPorCargo(id)); return "/funcionario/lista"; }
	 * 
